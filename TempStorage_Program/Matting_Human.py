...
if __name__ == '__main__':
	...
	parser.add_argument(	'--output_dir',	default='./examples/PPPPPP',		help=""	)
	...
	if		Temp[-1]	==	'm':
		args.image_dir	=	Temp;
		args.trimap_dir	=	Temp[0:-5]						+	'_NewTriMap';
		args.output_dir	=	args.image_dir[0:-5]	+	'_Matting'
	elif	Temp[-1]	==	'p':
		args.image_dir	=	Temp[0:-10]	+	'_Trim';
		args.trimap_dir	=	Temp;
		args.output_dir	=	args.image_dir[0:-5]	+	'_Matting'


	if(os.path.isdir(	args.output_dir	) == True):
		#Remove SaveFolder
